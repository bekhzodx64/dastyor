    ...
    <UserMenu>
      <div className='user-profile'>
        <div className='user-profile__img'>
          ...
          <svg onClick={() => setModal(true)} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
               width="24" height="24">
        ...
        <div className={modal ? 'profile__change active' : 'profile__change'}>
          <form className="profile__form" onSubmit={_onSubmit}>
            <svg onClick={() => setModal(false)} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
                 width="24" height="24">
              <path fill="none" d="M0 0h24v24H0z"/>
              <path
            ...
            <div className="profile__img">
              <img
                src={(typeof initialValues.photo != "string" && initialValues.photo != null && typeof initialValues.photo != "undefined") ? URL.createObjectURL(initialValues.photo) : initialValues.photo}
                alt="Dastyor Express"/>
              <label htmlFor='change'>
                ...
                <input
                  ...
                  }} required={true} multiple={false} hidden={true}/>
              </label>
            </div>
